<form action="{{ route('search') }}" method="post" name="formUsual" id="formUsual"
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 margin_bottom_10">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding_right_5">
                    <select name="mfg_form_year" class="form-control">
                        <span class="text-bold">Mfg</span>
                        <option value>Mfg.
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding_right_5">
                    <select name="mfg_to_year" class="form-control">
                        <span class="text-bold">Mfg</span>
                        <option value>Mfg.
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 margin_bottom_10">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding_right_5">
                    <select name="mfg_form_month" class="form-control">
                        <span class="text-bold">Mfg</span>
                        <option value>Mfg.
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding_right_5">
                    <select name="mfg_to_month" class="form-control">
                        <span class="text-bold">Mfg</span>
                        <option value>Mfg.
