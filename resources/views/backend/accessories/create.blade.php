    ...
    <div class="card-body">
      <form method="post" action="{{route('accessories.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="comfort" type="text" name="comfort" placeholder="Enter title"  value="{{old('comfort')}}" class="form-control">
          @error('comfort')
        ...
        <div class="form-group">
          ...
          <input type="text" valu="{{old('other_feature')}}" class="form-control" id="other_feature" name="other_feature">
          @error('other_feature')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{old('selling_point')}}" class="form-control" id="selling_point" name="selling_point">
            @error('selling_point')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{old('safety_measure')}}" class="form-control" id="safety_measure" name="safety_measure">
            @error('selling_point')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{old('window_type')}}" class="form-control" id="window_type" name="window_type">
            @error('window_type')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{old('other_information')}}" class="form-control" id="other_information" name="other_information">
