...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <br>
            <div class="sarch">
                <form action="{{ route('SearchByStockId') }}" method="get">
                    @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('product.show', $product?->id) }}"
                                            ...
                                            title="show-details" data-placement="bottom"><i class="fas fa-eye"></i></a>
